...
export const APP_ICON_URL = `${APP_URL}/kuro-logo.png`;
export const APP_OG_IMAGE_URL = `${APP_URL}/kuro-banner.png`;
export const APP_SPLASH_URL = `${APP_URL}/kuro-logo.png`;
export const APP_SPLASH_BACKGROUND_COLOR = "#191970";
